...
- **Backend:** Firebase Spark Plan (Auth, Firestore, and Cloud Functions).
- **Vector DB:** Pinecone Free Tier (1 Free Index; handles similarity search).
...
## System Architecture
The app follows a "Thin Client" model to minimize battery usage by offloading heavy embedding computation to the cloud.
...
### Cloud-Based RAG Workflow
1. **Story Segment:** App sends text to Firebase Cloud Function
2. **Cloud Processing:** Function generates embeddings and stores in Pinecone
3. **Context Retrieval:** Relevant past events injected into AI prompts
