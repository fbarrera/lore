...
## Overview
Build the core AI engine with Gemini 3 Flash/Pro integration, implement the tri-part system instruction framework for dynamic storytelling, and establish basic Retrieval-Augmented Generation (RAG) using Firestore Vector Search for memory retrieval. This stage depends on the foundation established in Stage 1.
...
- Set up basic RAG system with Firestore Vector Search for memory retrieval
- Develop client-side logic for processing story segments and generating embeddings
...
- Basic RAG pipeline with Firestore Vector Search
- Client-side services for story segment processing and embedding generation
...
- **Vector Search:** Firestore Vector Search for embedding storage and retrieval
...
1. Set up Gemini 3 Flash/Pro API client in Flutter
...
3. Configure Firestore Vector Search indexes for story embeddings
4. Develop Flutter service for generating embeddings from story segments
5. Create Flutter service for story segment processing and AI generation
6. Update Firestore data schemas:
   - Add story_segments collection with vector fields
   - Modify stories collection to reference segments
   - Add embedding metadata fields
7. Implement basic RAG retrieval logic using Firestore Vector Search (client-side)
...
## Dependencies
- Stage 1: Foundation & Setup (Firebase, Firestore Vector Search, basic Flutter app)

## Estimated Effort
- Gemini API integration: 3-4 hours
- Tri-part system instruction framework: 4-5 hours
- Firestore RAG setup: 2-3 hours
...
- RAG system retrieves relevant story context from Firestore
